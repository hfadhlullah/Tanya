...
export class AuthService {
  ...
  private toPublic(user: { id: string; email: string; displayName: string | null; role: string; isGuest?: boolean }) {
    return { id: user.id, email: user.email, displayName: user.displayName, role: user.role, isGuest: user.isGuest ?? false };
  }
}
