## 1. Foundation
- [ ] 1.1 Scaffold the NestJS backend with `npm i -g @nestjs/cli && nest new Tanya`.
- [ ] 1.2 Scaffold the Expo React Native app using the selected Expo workflow.
- [ ] 1.3 Reference `docs/onboard-ux/` and lock the emerald UI direction before implementing MVP mobile screens.
- [ ] 1.4 Set up the React Native component structure using atomic design categories such as atoms, molecules, organisms, templates, and screens.
- [ ] 1.5 Add Docker Compose services for API, worker, and PostgreSQL with pgvector.
- [ ] 1.6 Configure separate staging and production environment variables for Coolify.

## 2. Data Model
- [ ] 2.1 Create schemas for users, ustadz profiles, credentials, questions, answers, citations, corpus chunks, sensitive rules, saved answers, audit logs, and analytics events.
- [ ] 2.2 Add pgvector extension and embedding indexes for corpus chunks and verified answers.
- [ ] 2.3 Seed initial roles and baseline sensitive-topic rules.

## 3. Question Answering
- [ ] 3.1 Implement mobile question submission and question history.
- [ ] 3.2 Run sensitive-topic classification before retrieval or answer drafting.
- [ ] 3.3 Route sensitive questions to ustadz review without returning an AI answer.
...
## Post-Implementation
- [ ] Update AGENTS.md in the project root for new architecture, commands, and operational constraints.
